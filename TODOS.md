Done:
- ✓ Generate a UIX standard file (references/uix-standards.md completed)
- ✓ Icon and graphic usage system (severity/status coloring in uix-standards.md)
- ✓ Links to external sites open in new tab (auto-applied via marked renderer in researchStore.js)
- ✓ Research modal with progress indicator (research-modal.ejs, research-modal.js)
- ✓ "Find All" button added to Make/Model vehicle page (vehicle-model.ejs, research-modal.js, findAllWorkflow.js)
- ✓ 100 dealership entries added for Portland, OR metro area (within 100 miles downtown Portland)
